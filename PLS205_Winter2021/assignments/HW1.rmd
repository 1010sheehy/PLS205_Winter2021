...
> However, the coefficient of variation does change from 0.3361213 to 0.1467572. This is because adding 10 to the values increases the mean of the data, which is in the denominator of the coefficient of variation formula, thus decreasing the size of the coefficient.
...
> The true population variance for standing is \simulation1_sitting_var.
...
> The true standard error for sitting is \simulation1_sitting_se.
> The true standard error for standing is \simulation1_standing_se.
