...
```{r}
# nitrogen levels effect on biomass
nitrogen_means = emmeans(biomass_1_model,spec = 'nitrogen',by = 'weed')
nitrogen_effects = contrast(nitrogen_means,'pairwise')
cld(nitrogen_means,level = 1-0.05/3)
```
...
spec_eff_nitrogen_model <- lmer(perc_biomass ~ nitrogen + nitrogen:weed + (1|tray), data = biomass_1)
anova(spec_eff_nitrogen_model)

# Estimate how much nitrogen effects change for species Weed_2 relative to Weed_1.
