...
means_by_nitrogen <- emmeans(biomass_1_model, specs = 'nitrogen', by = 'weed')
means_by_nitrogen

nitrogen_effects <- contrast(means_by_nitrogen, 'pairwise')
cld(means_by_nitrogen, level = 0.05/3)
```
...
# interaction effects - changes in the specific effects between weeds
